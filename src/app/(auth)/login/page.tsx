        ...
        <div className="bg-white rounded-xl border border-gray-200 p-6 shadow-sm">
          ...
          >
            ...
            <input
              ...
              className="w-full px-4 py-2.5 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent mb-3"
            />
            <button
              type="submit"
